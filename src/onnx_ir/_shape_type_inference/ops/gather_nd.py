...
class GatherNDInferrer(_common.NodeInferrer):
    ...
    def infer(self, node: ir.Node) -> _common.InferenceResult:
        ...
        if indices_shape is None:
            return _common.InferenceResult(failure="GatherND indices input shape is not known.")
        ...
        if indices_rank == 0:
            return _common.InferenceResult(failure="GatherND indices input cannot be a scalar.")
