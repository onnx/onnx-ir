"""ReduceProd operation inferrer for ONNX IR nodes."""
...
class ReduceProdInferrer(_common.NodeInferrer):
    """Inferrer for ReduceProd operations."""

    def __init__(self) -> None:
        """Initialize the ReduceProd inferrer."""
        super().__init__("ReduceProd", opsets=range(sys.maxsize))
