...
class AveragePoolInferrer(_common.NodeInferrer):
    ...
    def infer(self, node: ir.Node) -> _common.InferenceResult:
        ...
        if input_rank < 3:
            return _common.InferenceResult(failure="AveragePool input must have at least 3 dimensions.")
        ...
        if kernel_shape is None:
            return _common.InferenceResult(failure="AveragePool requires kernel_shape attribute.")
