...
def infer_scatter_elements_shape(node: ir.Node, shape_env: ShapeEnv) -> InferenceResult:
    """Shape inference for ScatterElements op."""
    ...
    # Output shape is the same as the data input shape
