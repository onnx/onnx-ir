...
def infer_div_shape(node: ir.Node, shape_env: ShapeEnv) -> InferenceResult:
    """Shape inference for Div op."""
    input_shapes = []
    input_dtype = None
    for input_value in node.inputs:
        ...
        if input_dtype is None:
            ...
            return InferenceResult(InferenceStatus.FAILURE, "Incompatible input dtypes for Div op.")
